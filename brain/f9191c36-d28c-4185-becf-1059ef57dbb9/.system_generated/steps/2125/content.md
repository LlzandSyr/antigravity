...
Source: https://share.note.youdao.com/s/61tfjn9a
...
<script type="text/javascript">
  ...
  function redirectToTarget(isYdoc, isMobile) {
    ...
    window.location.href = '//share.note.youdao.com/' + (isYdoc ? noteShareUrl : groupShareUrl) + '/' + (isMobile ? 'mobile.html' : 'index.html')  + search + location.hash;
  }
</script>
</body>
</html>

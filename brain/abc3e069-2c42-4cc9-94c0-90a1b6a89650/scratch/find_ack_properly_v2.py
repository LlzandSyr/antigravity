...
def main():
    ...
    for name in os.listdir(desktop):
        ...
        if os.path.isdir(p) and ("优秀毕业论文" in name or name.startswith("优秀")):
            found_dir = p
            break
            
    if not found_dir:
        # Fallback to direct path check if isdir had an issue
        found_dir = r"C:\Users\86135\Desktop\优秀毕业论文"
